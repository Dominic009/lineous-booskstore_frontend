        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 lg:gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
            >
              <img src="/logowtext.png" alt="" className="w-24 h-24 lg:w-32 lg:h-32" />
            </motion.a>
            <p className="text-primary-foreground/70 mb-4 lg:mb-6 max-w-sm text-sm lg:text-base">
            ...
            {/* <div className="flex items-center gap-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
                  className="p-2 rounded-full bg-primary-foreground/10 text-primary-foreground/70 hover:bg-primary hover:text-primary-foreground transition-colors"
